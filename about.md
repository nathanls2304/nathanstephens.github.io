...
- Spacecraft ADCS & orbital mechanics
- Rocket nozzle design and compressible flow
- Structural analysis & lightweight design
- MATLAB/Simulink modeling, simulation, and verification
...
- Mission design and multi-disciplinary engineering
...
- Contribute to aircraft, UAV, or spacecraft development programs
- Improve aerodynamic efficiency and stability through innovative design
- Support mission design and modeling for next-generation aerospace systems
...
- Planespotting & Aviation Photography: I love capturing aircraft in motion — whether it’s commercial jets, regional turboprops, or military flyovers.
- Gaming: I enjoy a range of games, including flight simulators, racing games, story-driven adventures, and strategy games.
- Sci-Fi & Movies: I’m a fan of anything related to world-building and sci-fi engineering.
- Cars: I’m not a hardcore car person, but I enjoy learning about vehicle design, powertrains, and handling physics.
- Friends & Family: I value spending time with the people close to me — whether that’s relaxing, exploring new places, or just hanging out.
